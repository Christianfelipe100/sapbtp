CLASS zcl_data_gen_ac_cjf DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_data_gen_ac_cjf IMPLEMENTATION.
...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 DATA: lt_acc_categ TYPE TABLE OF ztb_acccat_3430,
       lt_catego    TYPE TABLE OF ztb_categ_cjf,
       lt_clientes  TYPE TABLE OF ztb_clientes_cjf,
       lt_clnts_lib TYPE TABLE OF ztb_clnt_lib_cjf,
       lt_libros    TYPE TABLE OF ztb_lib_cjf.
...
******** ztb_acccat_3430 ********
    ...
    delete from ztb_acccat_3430.
    insert ztb_acccat_3430 from table @lt_acc_categ.
...
******** ztb_categ_cjf ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_categ_cjf.
    insert ztb_categ_cjf from table @lt_catego.
...
******** ztb_clientes_cjf ********
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clientes_cjf.
    insert ztb_clientes_cjf from table @lt_clientes.
...
******** ztb_clnt_lib_cjf
    ...
    "Delete possible entries; insert new entries
    delete from ztb_clnt_lib_cjf.
    insert ztb_clnt_lib_cjf from table @lt_clnts_lib.
...
******** ztb_lib_cjf ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ztb_lib_cjf.
    insert ztb_lib_cjf from table @lt_libros.
